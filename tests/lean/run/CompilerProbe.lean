...
/-- info: #["Lean.«_aux_Init_NotationExtra___macroRules_Lean_command__Unif_hint____Where_|_-⊢__1»",
  ...
  "Lean.withTraceNode._at_.Lean.Compiler.LCNF.PassManager.run.spec_0._redArg",
  "Lean.Parser.Tactic.Doc.initFn._lam_2._@.Lean.Parser.Tactic.Doc._hyg.1027",
  ...
  "Lean.Meta.mkCongrSimpCore?.mk?.go", "Lean.Linter.MissingDocs.initFn._lam_2._@.Lean.Linter.MissingDocs._hyg.1243",
  ...
  "Lean.withTraceNode._at_.Lean.Meta.Simp.discharge?'.spec_7._redArg", ⋯]
-/
#guard_msgs in
#eval
...
/-- info: #[("USize.ofNat", 111), ("EStateM.Result.ok", 137)] -/
#guard_msgs in
#eval
  Probe.runOnModule `Lean.Compiler.LCNF.JoinPoints (phase := .mono) <|
  Probe.getLetValues >=>
